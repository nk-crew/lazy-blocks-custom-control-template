...
if ( ! class_exists( 'NAMESPACE_Lzb_Control_CONTROL_NAME' ) ) :
	...
	class NAMESPACE_Lzb_Control_CONTROL_NAME extends LazyBlocks_Control {
		...
		public function register_assets() {
			...
			$script_data = NAMESPACE_Lzb_Plugin_CONTROL_NAME::get_asset_file( $path );

			wp_register_script(
				'NAMESPACE-lzb-control-CONTROL_NAME',
				NAMESPACE_Lzb_Plugin_CONTROL_NAME::$plugin_url . $path . '.js',
			...
			wp_register_style(
				'NAMESPACE-lzb-control-CONTROL_NAME',
				NAMESPACE_Lzb_Plugin_CONTROL_NAME::$plugin_url . $path . '.css',
				array(),
				$script_data['version']
			);
			wp_style_add_data( 'NAMESPACE-lzb-control-CONTROL_NAME', 'rtl', 'replace' );
		}
